...
class barber_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('barber_instagram_photo',esc_html__('[ Barber ] Intagram Photo','barber-companion'),array(
			'description' => esc_html__('Barber Instagram Photo Widget','barber-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'barber-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'barber-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'barber-companion'); ?></label>
