...
class Barber_newsletter_widget extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Barber ] Newsletter Form', 'barber-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer newsletter signup form.', 'barber-companion' ), )
        );
    ...
    if( $desc ){
        ...
        <div class="form-wrap" id="mc_embed_signup">
            <form target="_blank" action="<?php echo esc_url( $actionurl ); ?>" method="post" class="barber_mailchimp_newsletter_widget">
    ...
    public function form( $instance ) {
        ...
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Newsletter', 'barber-companion' );
        }
        ...
        if ( isset( $instance[ 'desc' ] ) ) {
            ...
            $desc = esc_html__( 'Subscribe newsletter to get all updates about discount and offers.', 'barber-companion' );;
        }
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'actionurl' ) ); ?>"><?php esc_html_e( 'Action URL:' ,'barber-companion'); ?></label>
            <p class="description"><?php esc_html_e( 'Enter here your MailChimp action URL.' ,'barber-companion'); ?> </p>
